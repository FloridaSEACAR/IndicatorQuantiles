  ...
  if(!h=="Water Column"){
    ...
    flag_table <- data_combined_subset[,
                                       .(n_high = sum(q_subset == "high"),
                                         ...
                                         n_high_flagged2 = sum(str_detect(SEACAR_QAQCFlagCode, "17Q")),
                                         n_low = sum(q_subset == "low"),
                                         n_low_flagged = sum(q_subset=="low" & str_detect(SEACAR_QAQCFlagCode, "16Q")),
                                         n_low_flagged2 = sum(str_detect(SEACAR_QAQCFlagCode, "16Q"))),
                                       by = ParameterName]
...
cat("* n_low_flagged2 and n_high_flagged2 are the values flagged within the database as 16Q or 17Q, respectively; regardless of whether our script has them flagged")
cat("  \n")
...
```{r SAV-BB Expected Data Check, eval=TRUE, results='asis'}
