...
quantile_table_display <- function(quantile, hab) {
  if (hab == "Water Column"){
    ...
    for (type in types){
      ...
      indicators <- names(data_directory[[hab]][[type]])
...
\newpage
# Excluded Programs
The following programs are excluded from viewing in the tables below:  

```{r excluded_programs, results='asis'}

cat("  \n")
for (pid in exclude_programs){
  cat(paste0("* *",pid,"*"))
  cat("\n")
}
cat("  \n")
