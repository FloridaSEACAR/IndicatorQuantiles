...
*q_low*: Value corresponding to the low quantile for the parameter in the DDI export.  

*q_high*: Value corresponding to the high quantile for the parameter in the DDI export.  
...
wc_program_table <- function(hab, type, i, p){
  ...
  if (nrow(q_values) > 0) {
    ...
    cat(subtitle, "\n\n")
    cat("  \n")
    cat(paste0("There are no Quantile Flagged Values for ", p))
    cat("  \n")
  }
}
